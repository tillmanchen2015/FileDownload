...
int main()
{	
	//FileDownload::getInstance()->HttpGet("http://speedtest.wdc01.softlayer.com/downloads/test10.zip", "test10.zip", NULL, NULL);
	//FileDownload::getInstance()->HttpGet("http://download.skycn.com/hao123-soft-online-bcs/soft/B/2015-06-24_BaiduMusic-12345617.exe", "testfile", NULL, NULL);
	return 0;
}
